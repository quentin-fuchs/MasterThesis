...
#SBATCH --array=0-39
#SBATCH --output=/home/qf226/MProject/thesis/logs/rescore_%A_%a.out
#SBATCH --error=/home/qf226/MProject/thesis/logs/rescore_%A_%a.err
...
MODEL_DIR="/home/qf226/rds/hpc-work/results/SigmaDock/sigmadock_pb_308"
...
python eval_sigmadock/scripts/gnina_rescore.py "${SEED_DIR}"
