...
#SBATCH --output=/home/qf226/MProject/thesis/logs/diffdock_merge_top1_%j.out
#SBATCH --error=/home/qf226/MProject/thesis/logs/diffdock_merge_top1_%j.err
...
python eval_diffdock/preprocess/merge_top1_runs.py \
    --runs_dir  "${RUNS_DIR}" \
